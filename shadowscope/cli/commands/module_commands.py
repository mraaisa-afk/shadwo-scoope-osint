...
from shadowscope.core import modules, storage, targets
...
def list(
    ...
    target_type: str | None = typer.Option(None, "--target-type", "-t", help="Filter by target type"),
...
def run(
    module: str,
    targets_list: builtins.list[str] | None = typer.Argument(None, help="Target(s) to run the module on"),
    all_targets: bool = typer.Option(False, "--all", "-a", help="Run on all targets in scope"),
    tag: str | None = typer.Option(None, "--tag", "-t", help="Run on targets with this tag"),
    type: str | None = typer.Option(None, "--type", help="Run on targets of this type"),
    config: str | None = typer.Option(None, "--config", "-c", help="Module configuration as JSON"),
    timeout: int | None = typer.Option(None, "--timeout", help="Module timeout in seconds"),
