    ...
    def _detect_type(value: str) -> str:
        ...
        try:
            ...
            if p.suffix.lower() in [
                ".jpg", ".jpeg", ".png", ".pdf", ".doc", ".docx", ".docm",
                ".xls", ".xlsx", ".xlsm", ".ppt", ".pptx", ".pptm", ".gif",
                ".bmp", ".webp", ".exe", ".dll", ".zip", ".tar", ".gz"
            ]:
                return "file"
        except Exception:
            pass
...
class TargetManager:
    ...
    def add(self, target: str | Target, tags: list[str] | None = None,
            metadata: dict[str, Any] | None = None, **kwargs) -> Target:
    ...
    def add_bulk(self, targets: list[str | Target],
                 tags: list[str] | None = None,
                 metadata: dict[str, Any] | None = None) -> list[Target]:
    ...
    def remove(self, target: str | Target) -> bool:
    ...
    def get(self, target: str | int) -> Target | None:
    ...
    def get_all(self, target_type: str | None = None,
    ...
    def update(self, target: str | Target, **kwargs) -> bool:
    ...
    def tag(self, targets: list[str | Target], tags: list[str]) -> int:
    ...
    def untag(self, targets: list[str | Target], tags: list[str]) -> int:
    ...
    def import_from_file(self, file_path: str, target_type: str | None = None) -> int:
