...
class PGPFingerprintModule(BaseModule):
    ...
    def __init__(self, config: Optional[PGPFingerprintConfig] = None):
    ...
    async def _fetch_key_from_keyserver(self, fingerprint: str) -> Optional[str]:
    ...
    async def _fetch_key_by_email(self, email: str) -> Optional[str]:
    ...
    async def _fetch_key_by_username(self, username: str) -> Optional[str]:
    ...
    def _parse_key_block(self, key_block: str) -> Optional[PGPKeyInfo]:
    ...
    async def _verify_signature(self, fingerprint: str, signature: str, data: str) -> bool:
        ...
        console.print(f"[yellow]Signature verification requires python-gnupg library[/yellow]")
        return False
    ...
    async def _lookup_fingerprint(self, target: str) -> Optional[PGPKeyInfo]:
