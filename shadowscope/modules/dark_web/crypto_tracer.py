...
class CryptoTracerModule(BaseModule):
    ...
    def __init__(self, config: CryptoTracerConfig | None = None):
    ...
    async def _fetch_address_info(self, address: str, blockchain: str) -> AddressInfo | None:
    ...
    def _check_exchange(self, address: str, blockchain: str) -> str | None:
