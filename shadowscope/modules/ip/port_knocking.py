...
class PortKnockingModule(BaseModule):
    ...
    def __init__(self, config: PortKnockingConfig | None = None):
    ...
    async def detect_service(self, ip: str, port: int) -> dict[str, Any] | None:
    ...
    async def check_ssl(self, ip: str, port: int) -> dict[str, Any] | None:
