...
class ASNLookupModule(BaseModule):
    ...
    def __init__(self, config: ASNLookupConfig | None = None):
    ...
    async def query_source(self, source: str, ip: str) -> dict[str, Any] | None:
    ...
    async def query_ipinfo(self, ip: str, base_url: str) -> dict[str, Any] | None:
    ...
    async def query_ipapi(self, ip: str, base_url: str) -> dict[str, Any] | None:
    ...
    async def query_ipwhois(self, ip: str, base_url: str) -> dict[str, Any] | None:
    ...
    async def query_rdap(self, ip: str, base_url: str) -> dict[str, Any] | None:
    ...
    async def query_ripe(self, ip: str, base_url: str) -> dict[str, Any] | None:
    ...
    async def query_bgpview(self, ip: str, base_url: str) -> dict[str, Any] | None:
