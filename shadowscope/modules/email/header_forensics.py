...
class HeaderForensicsModule(BaseModule):
    ...
    def __init__(self, config: HeaderForensicsConfig | None = None):
    ...
    def parse_received_header(self, header: str) -> dict[str, Any] | None:
    ...
    def analyze_header_data(self, data: dict[str, Any]) -> dict[str, Any]:
        ...
        if private_ips:
            analysis["recommendations"].append(
                "Private IP addresses detected in headers - possible internal relay"
            )
