...
class BreachLookupModule(BaseModule):
    ...
    def __init__(self, config: Optional[BreachLookupConfig] = None):
    ...
    async def check_dehashed(self, email: str) -> Optional[Dict[str, Any]]:
    ...
    async def check_hunterio(self, email: str) -> Optional[Dict[str, Any]]:
