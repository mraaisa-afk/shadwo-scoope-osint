...
class SubdomainTakeoverModule(BaseModule):
    ...
    def __init__(self, config: Optional[SubdomainTakeoverConfig] = None):
    ...
    async def check_takeover_vulnerabilities(self, domain: str, 
        ...
        async def check_subdomain_takeover(subdomain: str) -> Optional[Dict[str, Any]]:
    ...
    def _get_cname_sync(self, subdomain: str) -> Optional[str]:
    ...
    def check_cname_vulnerability(self, subdomain: str, cname: str) -> Optional[Dict[str, Any]]:
    ...
    async def check_a_vulnerability(self, subdomain: str, ip: str) -> Optional[Dict[str, Any]]:
    ...
    async def check_aaaa_vulnerability(self, subdomain: str, ip: str) -> Optional[Dict[str, Any]]:
